...
class CustomerModel {
  ...
  int get stayNights => (checkInDate != null && checkOutDate != null)
      ? checkOutDate!.difference(checkInDate!).inDays.abs()
      : 0;
  ...
  factory CustomerModel.fromJson(Map<String, dynamic> j) => CustomerModel(
    ...
    checkInDate: j['checkInDate'] != null ? DateTime.parse(j['checkInDate']) : null,
    checkOutDate: j['checkOutDate'] != null ? DateTime.parse(j['checkOutDate']) : null,
