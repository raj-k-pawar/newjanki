...
/// Shows a calendar dialog. Returns the selected date, or null if cancelled.
Future<DateTime?> showDatePickerDialog(
  BuildContext context, {
  DateTime? initial,
}) async {
  DateTime focused = initial ?? DateTime.now();
          ...
          child: Column(
            ...
            children: [
              TableCalendar(
                ...
                onDaySelected: (sel, foc) => setSt(() {
                  selected = sel;
                  focused = foc;
                }),
                onPageChanged: (foc) => setSt(() => focused = foc),
              ),
