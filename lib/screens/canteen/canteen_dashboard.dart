...
class _ScanQrTabState extends State<_ScanQrTab> with WidgetsBindingObserver {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_resultMsg != null) ...[
          ...
          // Customer detail card (only shown for valid scans)
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    CircleAvatar(
                      ...
                      child: Text(
                        _resultCustomer!.name[0].toUpperCase(),
                        style: GoogleFonts.poppins(
                            fontSize: 20, fontWeight: FontWeight.w700,
                            color: Colors.white),
                      ),
                    ...
                    Expanded(child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(_resultCustomer!.name,
                            style: GoogleFonts.poppins(
                                fontSize: 17, fontWeight: FontWeight.w700,
                                color: Colors.white)),
                        const SizedBox(height: 2),
                        Text(_resultCustomer!.city,
                            style: GoogleFonts.poppins(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _resultCustomer!.canteenServed
                            ? AppColors.success
                            : AppColors.warning,
                ...
                Padding(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Container(
                      ...
                      child: Text(_resultCustomer!.packageName,
                          style: GoogleFonts.poppins(
                    ...
                    Row(children: [
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('${_resultCustomer!.totalGuests} guests',
                            style: GoogleFonts.poppins(
                ...
                if (_resultCustomer!.food.breakfast > 0 ||
                    _resultCustomer!.food.lunch > 0 ||
                    _resultCustomer!.food.snacks > 0 ||
                    _resultCustomer!.food.dinner > 0) ...[
                  Padding(
                    padding: const EdgeInsets.fromLTRB(16, 14, 16, 0),
                    child: Row(children: [
                      Container(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(children: [
                        if (_resultCustomer!.food.breakfast > 0)
                          _foodDetailRow('🍽️', 'Breakfast',
                              _resultCustomer!.food.breakfast,
                              isFirst: true),
                        if (_resultCustomer!.food.lunch > 0)
                          _foodDetailRow('🍛', 'Lunch',
                              _resultCustomer!.food.lunch,
                              isFirst: _resultCustomer!.food.breakfast == 0),
                        if (_resultCustomer!.food.snacks > 0)
                          _foodDetailRow('☕', 'Snacks',
                              _resultCustomer!.food.snacks,
                              isFirst: _resultCustomer!.food.breakfast == 0 &&
                                  _resultCustomer!.food.lunch == 0),
                        if (_resultCustomer!.food.dinner > 0)
                          _foodDetailRow('🌙', 'Dinner',
                              _resultCustomer!.food.dinner,
                              isFirst: _resultCustomer!.food.breakfast == 0 &&
                                  _resultCustomer!.food.lunch == 0 &&
                                  _resultCustomer!.food.snacks == 0),
                      ]),
  ...
  Widget _foodDetailRow(String emoji, String label, int count,
      {bool isFirst = false}) {
    return Container(
